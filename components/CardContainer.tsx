...
const CardContainer: FunctionComponent = () => (
    <div className="flex flex-col">
        ...
        <div className="flex justify-center p-8" >
            <a className="flex flex-col w-full bg-white rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5 hover:bg-gray-100" href={"signup?tournament_id=4"}>
                ...
                <div className="flex flex-col w-full md:flex-row">
                    <div className="flex flex-row justify-around p-4 font-bold leading-none text-gray-800 uppercase bg-gray-400 rounded md:flex-col md:items-center md:justify-center md:w-1/4">
                        <div className="md:text-3xl">Mar</div>
                        <div className="md:text-6xl">11</div>
                        <div className="md:text-l 2xl:text-xl">9-11:30pm</div>
                    </div>
                    <div className="font-normal text-gray-800 flex flex-col w-full">
                        <div className="p-4">
