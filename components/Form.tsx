    ...
    return (
        <form className="w-full max-w-xl self-center bg-gray-50 p-5">
            ...
            <div className="flex items-start mb-6">
                ...
                <label htmlFor="terms" className="ml-2 text-sm font-medium text-gray-900 ">I am at least 18 years old and agree with the <a href="https://www.keepandshare.com/doc13/31085/injury-waiver-pdf-34k?da=y" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">terms and conditions</a></label>
            </div>
